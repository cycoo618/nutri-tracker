...
设计稿渲染快照在 `screenshots/` 文件夹,按编号排列:

| # | 文件 | 内容 |
|---|---|---|
| 01 | `01-home-diary.png` | 营养日记本 首页(默认 morning-green 色板)|
| 02 | `02-home-diary-add-sheet.png` | 点 + 弹出的"记一笔"sheet(餐次 / 录入方式 / 常用食物频次)|
| 03 | `03-today-detail.png` | 今日明细 — 73 分 hero + 四大宏量 / 留心摄入 / 食物多样性 / 微量元素 |
| 04 | `04-food-diversity-detail.png` | 食物多样性 7 天详情 |
| 05 | `05-trends.png` | 趋势屏 — 周节奏、能量曲线、热力图 |
| 06 | `06-pantry.png` | 食材库 |
| 07 | `07-profile.png` | 我的(目标优先级、身体数据、偏好)|
| 08 | `08-science.png` | 科学室 |
| 09 | `09-home-garden.png` | 七色花园 首页(抗炎主目标用)|
| 10 | `10-home-garden-add-sheet.png` | 花园 + sheet |
| 11–13 | `11-palette-coconut.png` / `12-palette-lemon.png` / `13-palette-peach.png` | 同一日记本首页,其余 3 套色板下的表现 |
...
| 今日明细 (Detail) | `screens/macros.jsx` | 宏量平衡 · 留心摄入(添加糖/钠/胆固醇/反式脂肪) · 食物多样性 · 微量元素(钙铁钾镁锌) · 7 天评分 · 今晚建议 — 从首页两个 mini-stat 点击进入 |
...
| 食物多样性详情 | `screens/diversity.jsx` | 7 类食物每张独立卡 + 7天历史小条带 + 推荐食物 (从今日明细的"查看 7 天历史 ›" 进入) |
